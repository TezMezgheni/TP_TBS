...
import net.thevpc.gaming.atom.examples.kombla.main.client.dal.RMIClientDAL;
import net.thevpc.gaming.atom.examples.kombla.main.client.dal.MainClientDAOListener;
import net.thevpc.gaming.atom.examples.kombla.main.client.dal.TCPMainClientDaoImpl;
...
public class MainClientEngine extends AbstractMainEngine {
    ...
    protected void sceneActivating() {
        ...
        dao = new TCPMainClientDaoImpl();
//        dao = new UDPMainClientDAO();
//        dao= new RMIClientDAL();
