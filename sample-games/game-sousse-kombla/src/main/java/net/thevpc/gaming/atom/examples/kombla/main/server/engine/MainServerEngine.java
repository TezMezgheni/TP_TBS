...
import net.thevpc.gaming.atom.examples.kombla.main.server.dal.RMIServerDAL;
import net.thevpc.gaming.atom.examples.kombla.main.server.dal.TCPMainServerDAOImpl;
...
public class MainServerEngine extends BaseMainEngine {
    ...
    protected void sceneActivating() {
        ...
        dal = new TCPMainServerDAOImpl();
//        dal = new UDPMainServerDAO();
//        dal = new RMIServerDAL();
